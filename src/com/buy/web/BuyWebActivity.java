...
public class BuyWebActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText( this, "正在跳转到淘宝手机页面，淘宝认证，请放心购买！", Toast.LENGTH_LONG ).show( );
    ...
    protected void onDestroy() {
        ...
        /*
         * fix bug java.lang.IllegalArgumentException: Receiver not registered: android.widget.ZoomButtonsController$1@43907880
    ...
    public void setCurrentTitleString() {
        ...
        setTopBtnBackground( R.drawable.selector_back, R.drawable.selector_naviation_help );
    }
