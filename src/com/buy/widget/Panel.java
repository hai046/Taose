...
public class Panel extends LinearLayout {
    ...
    public Panel(Context context, AttributeSet attrs) {
        ...
        mDuration = a.getInteger( R.styleable.Panel_animationDuration, 300 ); // duration defaults to 750 ms
    ...
    Runnable startAnimation = new Runnable( ) {
        public void run() {
            ...
            MyLog.e( "panel", "fromXDelta=" + fromXDelta + " toXDelta=" + toXDelta + " fromYDelta=" + fromYDelta + " toYDelta=" + toYDelta );
            // if (isHide && toYDelta > 0) {
            // isHide = false;
            // return;
            // }
