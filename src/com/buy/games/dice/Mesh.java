...
public class Mesh {
    ...
    public float rz = 0;
    private float maxTX = 0.9f;
    public boolean start = false;
    float stepTx = 0.4f;
    public boolean isLeft = true;

    public boolean openCup = false;
    ...
    public interface CallBack {
        void isScroolToLeft(boolean flag);
    }
    ...
    public void draw(GL10 gl) {
        ...
        if (start) {
            ...
            if (isLeft) {
                ...
                if (x < -maxTX) {
                    isLeft = !isLeft;
                    if (mCallBack != null) {
                        mCallBack.isScroolToLeft( isLeft );
                    }
                }
            } else {
                x += stepTx;
        ...
        // gl.glRotatef( 2 * rx, -1, 0, 0 );
        // gl.glRotatef( ry, 0, 1, 0 );
        // gl.glRotatef( rz * 0.05f, 0, 0, 1 );
